...
window.Telegram.WebApp.openLink(`https://meal-coin.vercel.app/tonredirect?amount=${amount}&userId=${userData?.userId}`, { try_instant_view: true });
  ...
  const cards = [
    { id: 1, name: "OTMO-100,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039906/donald-bot1_dphe2y.jpg", ton: "0.3", stars: "99" },
    { id: 2, name: "ELMK-90,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039906/elon-bot1_usq2sw.jpg", ton: "0.2", stars: "60" },
    { id: 3, name: "APAM-80,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039906/ape-bot1_kzpd2h.jpg", ton: "0.1", stars: "45" },
    { id: 4, name: "DEQK-70,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039906/death-bot1_jydsgf.jpg", ton: "0.09", stars: "29" },
    { id: 5, name: "OPPM-60,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039907/optimus-bot4_t1lxqx.jpg", ton: "0.08", stars: "15" },
    { id: 6, name: "BUAR-50,000", image: "https://res.cloudinary.com/dkfmaqtpy/image/upload/v1741039907/optimus-bot3_nqycpo.jpg", ton: "0.07", stars: "9" },
